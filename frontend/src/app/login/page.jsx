...
const LoginPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    setTimeout(() => {
      ...
      toast.success('Welcome back to PredictX!');
      ...
      >
        <div className="bg-white p-10 rounded-[2.5rem] shadow-xl shadow-blue-100/50 border border-gray-100">
          <div className="flex flex-col items-center mb-10">
            ...
            <p className="text-gray-500 mt-2 font-medium">Log in to your PredictX dashboard</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button 
              type="submit"
              disabled={loading}
              className="w-full py-4 bg-blue-600 text-white rounded-2xl font-bold shadow-lg shadow-blue-100 hover:bg-blue-700 transition-all flex items-center justify-center"
            >
              {loading ? (
